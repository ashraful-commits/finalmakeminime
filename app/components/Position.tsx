...
const zoomOut = () => {
  ...
  return (
    <div className="controls mt-1 max-sm:w-full w-[50%] max-w-4xl max-sm:max-w-full max-sm:justify-center space-y-10 flex flex-col justify-between items-center">
      ...
      <div className="flex justify-end max-sm:min-w-full max-sm:px-4 items-center min-w-80  gap-3 mt-5 max-sm:mb-2 w-full  px-3">
        <button
        ...
        <button
          className="px-20 max-sm:px-8 max-sm:w-full  py-2 bg-blue-500   text-white text-sm rounded hover:bg-blue-800 border flex justify-center items-center gap-2 max-sm:gap-1 w-full"
